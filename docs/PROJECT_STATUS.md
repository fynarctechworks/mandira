...
| Platform | PLAT-03 Schema | TRD-DB-001, TRD-DB-002, TRD-DB-004 | IN_PROGRESS | PLAT-01 | 2026-08-25 | B-003 done: local Supabase (ports 544xx, D-026), `0001_enums.sql` (26 enums) + `0002_locales_sources_trust.sql` (12 tables, RLS on all, trust derivation + versioning triggers, en/te/hi seeded). 73 pgTAP tests, `db lint` clean, both wired into CI. Plan: docs/plans/PLAT-03.md. **Remaining for PLAT-03:** §4.4–§4.7 knowledge/users/journeys/reports + published views → B-004. |
