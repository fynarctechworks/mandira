...
| Platform | PLAT-03 Schema | TRD-DB-001/002/004/005, TRD-ARCH-004, PRD-KNOW-001/003 | COMPLETE | PLAT-01 | 2026-08-25 | B-003+B-004 done. 7 migrations, 51 tables, 9 `v_published_*` views, RLS enabled everywhere, 119 pgTAP tests, `db lint` clean, CI-enforced. Publish gate is structural: anon has no base-table grant. Plans: docs/plans/PLAT-03.md. RLS *policies* are B-006; generated types B-005. |
