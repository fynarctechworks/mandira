...
| Ops core | Ops shell + editors | PRD-OPS-CNT-001, PRD-KNOW-001/004 | IN_PROGRESS | AUTH-05 | 2026-08-25 | B-008 shell + B-009 destinations/places + B-010 experiences (with the availability rule builder), routes (drag-ordered stops), transport, accessibility panels and guidance. Nav O01–O07 live; O06 delivered inside Places/Routes (D-046). 119 vitest + 19 Playwright. Plans: OPS-SHELL.md, OPS-EDIT-01-02.md, OPS-EDIT-03-06.md. Next: B-011 trust panel + sources registry. |
