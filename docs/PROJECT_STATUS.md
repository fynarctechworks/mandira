...
| Ops core | Ops shell + editors | PRD-OPS-CNT-001 | IN_PROGRESS | AUTH-05 | 2026-08-25 | B-008 done: role-gated shell with sidebar over all 22 screens (unbuilt ones disabled + milestone-labelled, D-041), cmdk palette on the same model, `OpsDataTable` in packages/ui (react-table v8, D-040), Ops home. 113 vitest + 10 Playwright. Plan: docs/plans/OPS-SHELL.md. Next: B-009 destination/place editors. |
