...
export default defineConfig({
  ...
  projects: [
     ...
     */
    {
      ...
      testIgnore:
        /web[\\/](journey-builder|prepare|live|offline|changes|notifications|record|add-to-journey|profile|saved-places|reorder|health-sheet|preview|day-tabs|journey-cards)\.spec\.ts/,
    },
    ...
    // enough on their own to push the first account past `journeys_write`.
    {
      ...
      testMatch: /web[\\/](add-to-journey|profile|reorder|day-tabs|journey-cards)\.spec\.ts/,
      dependencies: ["web-setup"],
    },
...

    {
      ...
      testMatch:
        /ops[\\/](shell-nav|editors|knowledge|trust|publish|ingestion|queues|dashboards|workflow|admin|content|phrases|relationships)\.spec\.ts/,
    },
  ],
  webServer: [
    {
